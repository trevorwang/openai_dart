...
abstract class $ChatMessageCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? content, ChatMessageRole role, dynamic functionCall});
}
...
class _$_ChatMessage implements _ChatMessage {
  const _$_ChatMessage(
      {required this.content, required this.role, this.functionCall});
  ...
  @override
  String toString() {
    return 'ChatMessage(content: $content, role: $role, functionCall: $functionCall)';
  }
